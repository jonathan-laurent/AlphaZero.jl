...
learning(;l2_regularization=1e-4, lr=1e-3, batch_size=32) = LearningParams(
  use_gpu=false,
...
params(;num_iters=2, kwargs...) = Params(
  arena=arena(),
  self_play=self_play(),
...
experiment() = Experiment(
  "tictactoe",
  GameSpec(),
  params(;num_iters=2, l2_regularization=1e-4, lr=1e-3, batch_size=32),
  Network,
  netparams(),
  benchmark=benchmark())
